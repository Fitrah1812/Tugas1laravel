            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <table class="table">
                    <thead class = "thead-dark">
                        <tr>
                                <th scope="col"><strong>Id Customer</strong></th>
                                <th scope="col"><strong>Nama Pertama</strong></th>
                                <th scope="col"><strong>Nama Terakhir</strong></th>
                                ...
                                <th scope="col"><strong>zip_code</strong></th>
                        </tr>
                    </thead>
                        @foreach($members as $member)
                            <tr>
                                ...
                                <th scope="row">{{$member['street']}}</th>
                                <th scope="row">{{$member['city']}}</th>
                                <th scope="row">{{$member['state']}}</th>
                                <th scope="row">{{$member['zip_code']}}</th>
                            </tr>
                        @endforeach
                            <tbody>
                            <tr>
